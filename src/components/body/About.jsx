  ...
  return (
        <div id="about">
            ...
            <div className="about-content">
              ...
              <p>
                My name is Katarzyna Wegrzynowicz. I am a front-end developer based in Chicago with a background in education and expertise in active listening and communication. My programming skills include Javascript, React JS, CSS, and HTMLgi. I also have some back-end experience using PostgreSQL. I love colors, animals, solving problems, and Dionne Warwick.
              </p>
            </div>
