  ...
  return (
        <div id="about">
            ...
            <div className="about-content">
              ...
              <p>
                My name is Katarzyna Wegrzynowicz. I am a highly-organized and detail-oriented full-stack developer based in Round Lake Beach, IL. I love deconstructing problems to develop solutions and have a strong background in education. I get excited about tackling new challenges, lifelong learning, and making things beautiful.
              </p>
              <p>My <a href="#skills">programming skills</a> include Javascript, React, Python, PHP, HTML/CSS, and PostgreSQL. I love colors, animals, and Dionne Warwick.
              </p>
            </div>
