    ...
    <div className="body">
     <div id="about">
       <h2>About</h2>
        ...
        <img className="img" src="https://github.com/katarzyna-kw/portfolio-website/blob/main/img/headshot-circle-bw.png?raw=true" alt="image of Katarzyna" />
      ...
      <h2>Portfolio</h2>
        <div className="portfolio-container">
          <a href="https://github.com/katarzyna-kw/election-map-project" target="_blank"><img className="portfolio-images" src="https://github.com/katarzyna-kw/portfolio-website/blob/main/img/portfolio-election-map.png?raw=true" alt="election map website screencapture" /></a>
          ...
          <a href="https://github.com/katarzyna-kw/quote-generator" target="_blank"><img className="portfolio-images" src="https://github.com/katarzyna-kw/portfolio-website/blob/main/img/portfolio-quote-generator.png?raw=true" alt="quote generator screencapture" /></a>
          <p>Responsive quote generator coded with vanilla Javascript</p>
          <a href="https://github.com/katarzyna-kw/lolcat" target="_blank"><img className="portfolio-images" src="https://github.com/katarzyna-kw/portfolio-website/blob/main/img/portfolio-cat-clock.png?raw=true" alt="cat clock screencapture" /></a>
          ...
          <a href="https://github.com/katarzyna-kw/fcc-challenge-2" target="_blank"><img className="portfolio-images" src="https://github.com/katarzyna-kw/portfolio-website/blob/main/img/portfolio-survey.png?raw=true" alt="survey form screencapture" /></a>
          ...
          <a href="https://github.com/katarzyna-kw/fcc-challenge-3" target="_blank"><img className="portfolio-images" src="https://github.com/katarzyna-kw/portfolio-website/blob/main/img/portfolio-school-website.png?raw=true" alt="mock school website screencapture" /></a>
          ...
          <a href="https://github.com/katarzyna-kw/stretch" target="_blank"><img className="portfolio-images" src="https://github.com/katarzyna-kw/portfolio-website/blob/main/img/portfolio-stretching-routine.png?raw=true" alt="digital stretching routine website screencapture" /></a>
